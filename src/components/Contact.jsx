...
const Contact = () => {
  ...
  return (
    ...
    className='text-center p-6 py-20  lg:px-32 w-full overflow-hidden' id = 'Contact'>
      <h1 className='text-2xl sm:text-4xl font-bold mb-1 text-center'>
...
<form  className='max-w-2xl mx-auto text-gray-600 pt-8'>
    ...
    <div  className='w-full md:w-1/2 text-left'>
        Your Name
        <input className='w-full border border-gray-300 rounded py-3 px-4 mt-2' type="Name" nam = 'Name' placeholder='Your Name' required/>
    </div>
    <div className='w-full md:w-1/2 text-left md:pl-4'>
        Your Email
        <input className='w-full border border-gray-300 rounded py-3 px-4 mt-2' type="Email" nam = 'Email' placeholder='Your Email' required/>
    </div>
    </div>
