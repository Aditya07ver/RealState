      ...
      <motion.div 
       ...
       className='container text-center mx-auto py-4 px-6 md:px-20 lg:px-32 text-white'>
        ...
        <div className='space-x-6 mt-16'>
            <a href="Projects" className='border border-white px-8 py-3 rounded-xl'>Project</a>
            <a href="Contact" className='border border-white px-8 py-3 rounded-xl bg-blue-500'>Contact Us</a>
